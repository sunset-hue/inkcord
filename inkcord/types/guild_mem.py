...
class GuildMember:
    ...
    def avatar(self) -> str | None:
        ...
        avatar = f"https://cdn.discordapp.com/{self.guild.id}/users/{self.user.id}/{self.__data["avatar"]}.{"gif" if self.__data["avatar"].startswith("a_") else "png"}" if self.__data.get("avatar") else None
        return avatar
    ...
    def premium_since(self) -> datetime.datetime | None:
        ...
        return datetime.datetime.fromisoformat(self.__data["premium_since"]) if self.__data.get("premium_since") else None
    ...
    def communication_disabled_until(self) -> datetime.datetime | None:
        ...
        return datetime.datetime.fromisoformat(self.__data["communication_disabled_until"]) if self.__data.get("communication_disabled_until") else None
